        ...
        <div class="rating">
          ...
          <div class="food-rating-wrapper">
            <ul v-show="food.ratings && food.ratings.length">
              <li v-show="needShow(rating.rateType,rating.text)" v-for="rating in food.ratings" class="food-rating-item">
                <div class="user">
...
.rating .food-rating-wrapper {
  padding: 0 18px;
}
.food-rating-wrapper .food-rating-item {
  position: relative;
  padding: 16px 0;
